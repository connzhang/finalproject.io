...
* Interestly, there is a obvious drop of drug-related death in Connectict at 2017 among all race group and an rebound of drug-related death after 2018 in all race group, except white.

### Distribution of death by race, gender, age

* Chart B shows the distribution of age in drug-related death. From the graph we can see that most of the drug-related death happens at age between 25 and 50.
* Chart C shows the sex distribution in drug-related death. From the graph wecan see that male always outnumber female in number of death across all race group.
* Chart C also shows that there exists an distinct variation in drug-related death across gender specifically among white. 
...
* Fentanyl and Heroin frequently used by younger age group (below 25 years old);
* Cocaine and Ethanol are widely used by older age group (main 40 to 45 years old);
* There is wide age variation in Benzodiazepine-related death.
...
* The spider plot above shows the different composition of drug use in different race group. We can see:
* Hispanic-Black has proportion of Fenranyl-related death, as compared to other race groups.
* Both Asian and Hispanic-White have high proportion of Heroin-related death, as compared to other race groups.
* Black and Other race groups have high proportion of Cocaine-related death, as compared to other race groups.
* White has high proportion of Heroin-related and Other-drug-relatd death, as compared to other race groups.
